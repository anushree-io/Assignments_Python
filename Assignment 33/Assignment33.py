...
def CreateLog(FolderName):
    ...
    if Ret == True:
        ...
        os.mkdir(FolderName)
        print("Directry for log filess gets created suuccessfully")
    ...
    for info in Data:
        ...
        fobj.write("Files Opened by Process: %s\n" % info.get("open_files_count"))
...
def ProcessScan():
    ...
    listprocess.sort(key = lambda x : x['memory_percent'], reverse = True)
